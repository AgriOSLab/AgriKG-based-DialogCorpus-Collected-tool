...
public class myBatisUtils {
    ...
    public void setDefault(){
        ...
        if (maxRecordId==null)
            redis.set("dialog.corpus.count", "1");
        else
            redis.set("dialog.corpus.count", String.valueOf(maxRecordId+1));
    }
}
